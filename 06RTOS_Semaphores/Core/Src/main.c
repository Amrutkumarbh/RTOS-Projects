...
void StartReceive02(void const * argument);
...
int main(void)
{
  ...
  osThreadDef(Rx_data, StartReceive02, osPriorityIdle, 0, 128);
  Rx_dataHandle = osThreadCreate(osThread(Rx_data), NULL);
...
/**
* @brief Function implementing the Rx_data thread.
* @param argument: Not used
* @retval None
*/
